...
public class Atraccion extends Producto {
	...
	private String[] usuarios; // El array podría ser de objetos Usuario en vez de String. Habría que adaptar
								// el método usuarioNoRecibido
	...
	private boolean usuarioNoRecibido(String user) { // Se me ocurrió este método sobre la marcha para saber ...
		for (String cadaUsuario : usuarios) { // ... si el usuario no se encuentra en nuestro arrray de usuarios
												// recibidos
